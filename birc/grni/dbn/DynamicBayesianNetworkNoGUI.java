...
//import org.omegahat.Simulation.MCMC.Examples.Binomial_HDBNmlfNoGUI;
...
//
//public class DynamicBayesianNetworkNoGUI {
//	
...
//	
//	public DynamicBayesianNetworkNoGUI(String inputFile ,int iterations){
//		
...
//	   if(priorSet){
//		   target = new Binomial_HDBNmlfNoGUI(nogenes, orderDbn, totalIterations, dbnInputData, beta, priorFile);
//	   }else{
//		   target = new Binomial_HDBNmlfNoGUI(nogenes, orderDbn, totalIterations,dbnInputData);
//	   }
//	   
...
//	   proposal =  new Binomial_HDBNprofNoGUI(diagVar, orderDbn, prng, totalIterations);
...
//		String inputFilePath = "C:/Users/devamuni/Documents/D_Result/data10G30T_en.txt";
//		DynamicBayesianNetworkNoGUI dbnNoGUI = new DynamicBayesianNetworkNoGUI(inputFilePath, 150000);
//		dbnNoGUI.dbnMcmcWithOutPrior();
//		dbnNoGUI.run();
//		dbnNoGUI.done();
//	}
//}
