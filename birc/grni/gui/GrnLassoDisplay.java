...
public class GrnLassoDisplay {
	
	protected JFrame frameLasso;
	protected GrnGuiHeader headerLasso = new GrnGuiHeader();
	
	protected JPanel headerPanelLasso;
...
//	protected JTextField nbTreesField;
	...
	public GrnLassoDisplay(JFrame frame)
	{
		frameLasso = frame;
		frameLasso.setBackground(Color.WHITE);
		frameLasso.setBounds(200, 200, 600, 400);
		
		frameLasso.setTitle("Lasso Inference");
		
		// add header panel
		headerPanelLasso = new JPanel();
		headerPanelLasso.setBackground(Color.WHITE);
		CardLayout cardLayout = new CardLayout();
		headerPanelLasso.setLayout(cardLayout);
		frameLasso.getContentPane().add(headerPanelLasso, BorderLayout.NORTH);
		headerPanelLasso.add(headerLasso, "header");
		...
		frameLasso.getContentPane().add(textFieldPanel, BorderLayout.CENTER);
...
//							chooser.setSelectedFile(new File("/Users/liuxingliang/Documents/workspace/GRNInfer_All/data/data_lasso.txt"));
...
//		bottomPanel.add(exitButton);	
		...
		frameLasso.getContentPane().add(bottomPanel,BorderLayout.SOUTH);
		...
		progressBarLasso = new JProgressBar();
		progressBarLasso.setStringPainted(true);
		//bagConstraintsbottom.ipady =15;
		bagConstraintsbottom .gridx = 1;
		bagConstraintsbottom .gridy = 1;
		bagConstraintsbottom .insets = new Insets(0,10,0,100);
		bottomPanel.add(progressBarLasso, bagConstraintsbottom);
