#include <stdio.h>
#include <stdlib.h>
#include "birc_grni_en_CommonFunction.h"
 ...
 */
JNIEXPORT void JNICALL Java_birc_grni_en_CommonFunction_elnet(JNIEnv *env, jclass cl, 
												jfloat parm, 
												jfloatArray x,
												jint x_row,
												jint x_column,
												...
												jobject jobject_ElnetResult)
{
	...
	//TEST
	// fp = fopen("E:\\LIU\\Code\\workspace\\GRNI_CMD\\java.txt", "a");
	// if (fp == NULL)
	// {
		// printf("Error opening file!\n");
		// exit(1);
	// }
	// for(iii = 0; iii < nlam; iii++)
		// fprintf(fp, "%20.15f\n", alm[iii]);
	// fclose(fp);
