...
public class DialogFactory {
    ...
    public static int getYesNoCancelDialog(Container parent, int opt, String title, String text)
    {
        ...
        int result = JOptionPane.showOptionDialog(parent, text, title,
            JOptionPane.YES_NO_CANCEL_OPTION, opt, null, choice, choice[1]);
        return result;
    }
    ...
    public static int getYesNoDialog(Container parent, int opt, String title, String text)
    {
        ...
        int result = JOptionPane.showOptionDialog(parent, text, title,
            JOptionPane.YES_NO_OPTION, opt, null, choice, choice[1]);
        return result;
    }
    ...
    public static void getOKDialog(Container parent, int opt, String title, String text)
    {
        ...
        JOptionPane.showOptionDialog(parent, text, title,
            JOptionPane.OK_OPTION, opt, null, new Object[] {oktext}, oktext);
    }
