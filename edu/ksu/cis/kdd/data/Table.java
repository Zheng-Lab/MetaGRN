...
/*    public Set getClassValues()
 ...
 // add by kasun
    // to load discretized dbn data in to the database object from the array data structure (int [][] dbnInputData) 
    public static Table createTableFromArray(int [][] dbnData){
    	return Database.createTableFromArray(dbnData).pickOneTable();
    }
    // end
