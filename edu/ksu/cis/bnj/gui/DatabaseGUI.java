...
import edu.ksu.cis.kdd.util.gui.*;
...
public class DatabaseGUI extends JFrame implements ActionListener, WindowListener, KeyListener, MouseListener
{
    class DataModel extends DefaultTableModel {
        public DataModel() { super(); }
        public DataModel(int arg0, int arg1) { super(arg0, arg1); }
        public DataModel(Vector arg0, int arg1) { super(arg0, arg1); }
        public DataModel(Object[] arg0, int arg1) { super(arg0, arg1); }
        public DataModel(Vector arg0, Vector arg1) { super(arg0, arg1); }
        public DataModel(Object[][] arg0, Object[] arg1) { super(arg0, arg1); }
    ...
    protected JButton execButton = null, connectButton = null, browseButton = null,
                      tableAddButton = null, tableRemoveButton = null, saveButton = null,
                      cancelSaveButton = null;
    protected Dimension scrSize = Toolkit.getDefaultToolkit().getScreenSize();
    protected JTable table = null, tableList = null, tableColumns = null, tablePKeys = null,
                     tableRKeys = null, tableIKeys = null, tableSuper = null,
                     tablePrevileges = null;
    protected DataModel dataModel = null, tableListModel = null, tableColumnsModel = null,
                     tablePKeysModel = null, tableRKeysModel = null, tableIKeysModel = null,
                     tableSuperModel = null, tablePrevilegesModel = null;
    protected JDialog connectDialog = null, infoDialog = null, tableDialog = null,
                      tableDisplayDialog = null, aboutDialog = null, saveDialog = null;
    ...
    protected JMenuItem dbInfo = null, dbTables = null, connectMenu = null, exit = null,
                        modeMenu = null, aboutMenu = null, loadMenu = null, saveMenu = null;
    ...
    protected void init()
    {
        ...
        constraint.gridwidth = 5; constraint.gridheight = 1;
        ...
        if (driverString != null && urlString != null && loginString != null &&
            passwdString != null) {
            connect();
        }
    }
    ...
    protected void setupSaveDialog() {
        ...
        constraint.gridx = 4; constraint.gridy = 0;
        constraint.gridwidth = 1;
        constraint.gridheight = 1;
        constraint.fill = GridBagConstraints.BOTH;
        constraint.weightx = 1.0;
        ...
        constraint.gridx = 3; constraint.gridy = 0;
        constraint.gridheight = 1;
        constraint.gridwidth = 1;
        constraint.fill = GridBagConstraints.BOTH;
        constraint.weightx = 1.0;
        ...
        constraint.gridx = 3; constraint.gridy = 1;
        constraint.gridheight = 1;
        constraint.gridwidth = 1;
        constraint.fill = GridBagConstraints.BOTH;
        constraint.weightx = 1.0;
        ...
        constraint.gridx = 3; constraint.gridy = 2;
        constraint.gridheight = 1;
        constraint.gridwidth = 1;
        constraint.fill = GridBagConstraints.BOTH;
        constraint.weightx = 1.0;
        ...
        constraint.gridx = 3; constraint.gridy = 3;
        constraint.gridheight = 1;
        constraint.gridwidth = 1;
        constraint.fill = GridBagConstraints.BOTH;
        constraint.weightx = 1.0;
        ...
        constraint.gridx = 3; constraint.gridy = 4;
        constraint.gridheight = 1;
        constraint.gridwidth = 1;
        constraint.fill = GridBagConstraints.BOTH;
        constraint.weightx = 1.0;
        ...
        constraint.gridx = 2; constraint.gridy = 0;
        constraint.gridheight = 1;
        constraint.fill = GridBagConstraints.BOTH;
        constraint.weightx = 0.5;
        constraint.weighty = 1.0;
    ...
    protected void setupAboutDialog() {
        ...
        aboutPane.setText(
         ...
         "<center><h1>SQL Query GUI</h1>" +
         "<h3>Version 0.0001b</h3>"+
         "<h2>By: Roby Joehanes</h2>"+
         "</center><BR>"+ // $NON-NLS-1$
         "<P>This program demonstrates basic APIs in JDBC. It also helped to demonstrate "+
         "the capabilities of the database underlying the engine. Hopefully it helps those" +         "who wishes to debug JDBC-based databases."+
         "<P>I created this program in order to learn JDBC. Now that I succeeded "+
         "and I hope you benefit from this program as well." +         "</body></html>" // $NON-NLS-1$
        );
    ...
    protected void setupTableDisplayDialog() {
        ...
        tableRKeys.setToolTipText("Table's imported key information "+
        "(i.e. other table's reference keys that point to this table's primary key");
    ...
    protected void setupConnectDialog() {
        ...
        constraint.gridx = 1; constraint.gridy = 3;
        constraint.gridheight = 1;
        constraint.gridwidth = 1;
        constraint.fill = GridBagConstraints.BOTH;
        constraint.weightx = 2.0;
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        if (source == execButton) {
            ...
            try {
                ...
                JOptionPane.showOptionDialog(this, "Query Error!",
            ...
            if (connect()) {
                JOptionPane.showOptionDialog(this, "Connected to the database!",
                "Connected!", JOptionPane.OK_OPTION, JOptionPane.INFORMATION_MESSAGE, null, new Object[] {"OK"}, "OK");
            }
            ...
            if (tableToSaveListModel.size() == 0) {
                JOptionPane.showOptionDialog(this, "You need to select tables to save!",
                "Error!", JOptionPane.OK_OPTION, JOptionPane.ERROR_MESSAGE, null, new Object[] {"OK"}, "OK");
                return;
            }
            String whereToSave = saveText.getText();
            if (whereToSave == null || whereToSave.length() == 0) {
                JOptionPane.showOptionDialog(this, "You need to specify the filename!",
                "Error!", JOptionPane.OK_OPTION, JOptionPane.ERROR_MESSAGE, null, new Object[] {"OK"}, "OK");
                return;
            }
    ...
    protected boolean checkConnect() {
        ...
        JOptionPane.showOptionDialog(this, "Cannot connect to the database!",
        "Error!", JOptionPane.OK_OPTION, JOptionPane.ERROR_MESSAGE, null, new Object[] {"OK"}, "OK");
        return false;
    }
    ...
    protected boolean save(String file){
        try {
            ...
            DialogFactory.getOKDialog(this, DialogFactory.ERROR,
    ...
    protected DataModel resultSetToDataModel(ResultSet rs) throws SQLException{
        ...
        while (rs.next()) {
            ...
            for (int i = 1; i <= numColumns; i++) {
                String columnValue = rs.getString(i);
                if (columnValue == null) row.add("null"); // $NON-NLS-1$
                    else row.add(columnValue);
            }
            data.add(row);
        }
    ...
    protected String getDatabaseInfo() {
        ...
        try {
            ...
            } else buf.append("Not all procedures are callable."+ln);
        } catch (Throwable e) { }
        try {
            if (dmd.allTablesAreSelectable()) {
                buf.append("All tables are selectable."+ln);
            } else buf.append("Not all tables are selectable."+ln);
        } catch (Throwable e) { }
        buf.append(ln);
        ...
        } catch (Throwable e) { buf.append("unspecified"); }
        buf.append(ln);
        ...
        try {
            if (dmd.supportsExtendedSQLGrammar()) buf.append("extended "); else
            if (dmd.supportsCoreSQLGrammar()) buf.append("core "); else
            if (dmd.supportsMinimumSQLGrammar()) buf.append("minimum ");
        } catch (Throwable e) { buf.append("unspecified"); }
        buf.append(ln);
        ...
        try {
            switch (dmd.getResultSetHoldability()) {
                case ResultSet.HOLD_CURSORS_OVER_COMMIT:
                    buf.append("Hold cursors over commit."+ln); break;
                case ResultSet.CLOSE_CURSORS_AT_COMMIT:
                    buf.append("Close cursors at commit."+ln); break;
                default:
                    buf.append("unspecified"+ln);
            }
        } catch (Throwable e) { buf.append("unspecified"+ln); }
        try {
        ...
        try {
            switch (dmd.getSQLStateType()) {
                case DatabaseMetaData.sqlStateSQL99:
                    buf.append("SQL99"); break;
                case DatabaseMetaData.sqlStateXOpen:
                    buf.append("X Open"); break;
                default:
        ...
        try {
            ...
            while (rs.next()) {
                buf.append("  "); // $NON-NLS-1$
                for (int i = 1; i <= column; i++) {
                    if (i == 2) buf.append(sqlTypes.get(new Integer(rs.getInt(2)))+"\t\t"); // $NON-NLS-1$
                    else {
                        String s = rs.getString(i);
                        buf.append(s+"\t"); // $NON-NLS-1$
                        if (s == null) {
                            buf.append("\t"); continue; // $NON-NLS-1$
                        } 
    ...
    protected ResultSet executeQuery(String query) throws SQLException {
        isError = false;
        if (connection == null) {
            JOptionPane.showOptionDialog(this, "Not connected to the database yet! Click option",
            "Error!", JOptionPane.OK_OPTION, JOptionPane.ERROR_MESSAGE, null, new Object[] {"OK"}, "OK");
            isError = true;
            return null;
        }
        ...
        if (query.length() == 0) {
            JOptionPane.showOptionDialog(this, "No commands entered! Please type some commands!",
            "Error!", JOptionPane.OK_OPTION, JOptionPane.ERROR_MESSAGE, null, new Object[] {"OK"}, "OK");
            isError = true;
            return null;
        }
    ...
    public void mouseClicked(MouseEvent evt) {
        ...
        if (source == tableList) {
            if (evt.getClickCount() > 1){
                ...
                tableColumns.revalidate(); tableColumns.repaint();
                tablePKeys.revalidate(); tablePKeys.repaint();
                tableRKeys.revalidate(); tableRKeys.repaint();
                tableIKeys.revalidate(); tableIKeys.repaint();
                tablePrevileges.revalidate(); tablePrevileges.repaint();
                tableSuper.revalidate(); tableSuper.repaint();
    ...
    public void keyPressed(KeyEvent evt) {
        ...
        } else if (source == connectButton || source == driver || source == url ||
                   source == login || source == passwd) {
        ...
        } else if (source == tableColumns || source == tablePKeys || source == tableRKeys ||
                   source == tableIKeys || source == tableSuper || source == tablePrevileges) {
