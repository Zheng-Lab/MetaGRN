...
public class ConverterGUI extends JFrame implements ActionListener, WindowListener
{
    ...
    protected JButton addButton = null, removeButton = null,
              convertButton = null, exitButton = null, browseButton = null;
    ...
    private void precache() {
        ...
        {
            JOptionPane.showOptionDialog(this, "Error! Cannot open converter configuration file!",
    ...
    {
        if (owner == null) {
            int answer = JOptionPane.showOptionDialog(this, "Are you sure you want to quit?", "Quitting",
                JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.WARNING_MESSAGE, null,
                new Object[] {"Yes", "No", "Cancel"}, "No");
            if (answer != 0) return;
            System.exit(0);
        }
        setVisible(false);
	...
	public void actionPerformed(ActionEvent evt)
	{
        ...
        } else if (source == convertButton)
        {
            ...
            if (max == 0) {
                JOptionPane.showOptionDialog(this, "No files to convert!",
                "Check", JOptionPane.OK_OPTION, JOptionPane.WARNING_MESSAGE, null, new Object[] {"OK"}, "OK");
                return;
            }
            ...
            if (allSuccess) {
                JOptionPane.showOptionDialog(this, "Files are converted!",
                "Success", JOptionPane.OK_OPTION, JOptionPane.INFORMATION_MESSAGE, null, new Object[] {"OK"}, "OK");
            } else {
                JOptionPane.showOptionDialog(this, "Files are converted, but some have errors!",
                "Success", JOptionPane.OK_OPTION, JOptionPane.WARNING_MESSAGE, null, new Object[] {"OK"}, "OK");
            }
        }
	}
