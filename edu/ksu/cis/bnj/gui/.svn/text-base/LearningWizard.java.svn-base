...
public class LearningWizard extends JFrame implements ActionListener, WindowListener, MouseListener {
    ...
    private JButton prevButton = null, nextButton = null, cancelButton = null, browseDataButton = null,
            tableRemoveButton = null, tableAddButton = null, launchDBGUIButton = null;
    ...
    private String[][] learningEngines = {
        {"K2", "edu.ksu.cis.bnj.bbn.learning.scorebased.k2.K2"},
        {"Genetic Algorithm Wrapper for K2 (GAWK)", "edu.ksu.cis.bnj.bbn.learning.scorebased.wrappers.gawk.GAWK"},
        {"Genetic Algorithm on Structure", "edu.ksu.cis.bnj.bbn.learning.scorebased.wrappers.slam.SLAM"},
        {"Greedy Structure Learning", "edu.ksu.cis.bnj.bbn.learning.scorebased.gradient.GreedySL"},
        {"Standard Hill-climbing", "edu.ksu.cis.bnj.bbn.learning.scorebased.gradient.HillClimbingSL"},
        {"Hill-climbing with adversarial reweighting", "edu.ksu.cis.bnj.bbn.learning.scorebased.gradient.HillClimbingARSL"},
        {"Hill-climbing with Dirichlet prior", "edu.ksu.cis.bnj.bbn.learning.scorebased.gradient.HillClimbingDPSL"},
        {"Simulated Annealing", "edu.ksu.cis.bnj.bbn.learning.scorebased.gradient.SimAnnealSL"},
        {"Stochastic structural learning", "edu.ksu.cis.bnj.bbn.learning.scorebased.gradient.StochasticSL"}
    };
            ...
            case 1:
               ...
               if (loadFromFileRadioButton.isSelected()) {
                   ...
                   try {
                       ...
                       if (ll.size() == 1) data = (Data) ll.get(0);
                           else data = db; 
                   } catch (Exception e) {
                       DialogFactory.getOKDialog(this, DialogFactory.ERROR,
                          "Error!",
            ...
            case 3:
                if (connection != null) {
                    try {
                        ...
                        DialogFactory.getOKDialog(this, DialogFactory.ERROR,
                           "Error!",
                           "Connection to database server aborted");
                           return;
                    }
                }
    ...
    private void execute() {
        ...
        if (outputFile != null && outputFile.trim().length() > 0) {
            try {
                ...
                DialogFactory.getOKDialog(this, DialogFactory.ERROR,
                   "Error!",
                   "Cannot save learned graph!");
            }
        }

        graphPanel.setGraph(graph);
        Thread runner = new Thread() { 
            public void run() { graphPanel.autoLayout(); }
        };
        runner.start();
    }
