...
public class InferenceWizard extends JFrame implements ActionListener, WindowListener {
    ...
    private JButton prevButton = null, nextButton = null, cancelButton = null, browseNetButton = null,
            browseEvidenceButton = null, browseOutputButton = null, browseRMSEButton = null, browseSamplesButton = null,
            seeRMSEPlotButton = null;
    private JRadioButton loadFromFileRadioButton = null, useScreenRadioButton = null,
            exactRadioButton = null, approxRadioButton = null,
            exactInfRadioButton[] = null, approxInfRadioButton[] = null;
    private JCheckBox evidenceButton = null, outputButton = null, rmseButton = null, dumpRMSEButton = null,
            generateSamplesButton = null, markovBlanketButton = null; 
    private JTextField loadFileText = null, evidenceFileText = null, outputFileText = null, rmseFileText = null,
            samplesFileText = null;
    ...
    private String[][] exactEngines = {
        {"Lauritzen-Spiegelhalter (LS) / junction tree", "edu.ksu.cis.bnj.bbn.inference.ls.LS"},
        {"Variable elimination (elimbel)", "edu.ksu.cis.bnj.bbn.inference.elimbel.ElimBel"},
        {"Loop Cutset Conditioning", "edu.ksu.cis.bnj.bbn.inference.cutset.BoundedCutset"},
        {"Pearl's propagation (for tree only)", "edu.ksu.cis.bnj.bbn.inference.pearl.Pearl"}
    };

    // This, too, should go to the config file
    private String[][] approxEngines = {
        {"Logic Sampling", "edu.ksu.cis.bnj.bbn.inference.approximate.sampling.LogicSampling"},
        {"Forward Sampling", "edu.ksu.cis.bnj.bbn.inference.approximate.sampling.ForwardSampling"},
        {"Likelihood Weighting", "edu.ksu.cis.bnj.bbn.inference.approximate.sampling.LikelihoodWeighting"},
        {"Self-Importance Sampling", "edu.ksu.cis.bnj.bbn.inference.approximate.sampling.SelfImportance"},
        {"Adaptive-Importance Sampling", "edu.ksu.cis.bnj.bbn.inference.approximate.sampling.AIS"},
        {"Pearl MCMC Method", "edu.ksu.cis.bnj.bbn.inference.approximate.sampling.PearlMCMC"},
        {"Chavez MCMC Method", "edu.ksu.cis.bnj.bbn.inference.approximate.sampling.ChavezMCMC"}
    };
               ...
               if (loadFromFileRadioButton.isSelected()) {
                   ...
                   if (filename == null || filename.length() == 0) {
                       DialogFactory.getOKDialog(this, DialogFactory.ERROR,
                          "Error!",
                          "You must fill in the file name first!");
                          return;
                   }
                   try {
    ...
    public void windowClosing(WindowEvent evt) { if (evt.getSource() == this) selected_Close(); }
