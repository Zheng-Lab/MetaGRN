...
public class BNJMainPanel extends JPanel implements ActionListener  {
    ...
    protected void buildMenu(JMenu menu) {
        ...
        for (int j = 0; j < maxj; j++)
        {
            ...
            if (item instanceof JMenu) buildMenu((JMenu) item);
    ...
    public void newGraph() {
        if (isModified()) {
            int result = DialogFactory.getYesNoDialog(this, DialogFactory.WARNING,
                Messages.getString("Dialog.OpenNewGraph"), // $NON-NLS-1$
    ...
    public void save() {
        if (openedFile == null)
            ...
            if (save(openedFile)) graphPanel.setModified(false);
    }
