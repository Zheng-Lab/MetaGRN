 ...
 */
public class ChanceVariableState extends VariableState {

	/**
	 * @param panel
	 */
	public ChanceVariableState(NodeManager owner, GraphPanel panel) {
		super(owner, panel);
	}
    ...
    protected BBNNode createNode(BBNGraph graph) {
        BBNNode  newNode = new BBNNode(graph, "NewNode"+(counter++));
        return newNode;
    }
}
