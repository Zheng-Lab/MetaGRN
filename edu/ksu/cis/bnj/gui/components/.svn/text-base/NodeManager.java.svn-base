...
public class NodeManager implements GraphListener {
    ...
    protected JPopupMenu propertiesPopup = null, nodeDeletePopup = null,
        edgeDeletePopup = null, normalPopup = null;
    ...
    public Object properties(Component c, int x, int y) {
        ...
        if (vVertex != null) {
            ...
            else getNormalPopup().show(c, x, y);
        }
        return null;
    }
    ...
    public void afterVertexRemoved(GraphRemoveVertexEvent event){ modified = true; }
    public void beforeEdgeAdded(GraphAddEdgeEvent event) throws Exception { }
    public void afterEdgeAdded(GraphAddEdgeEvent event) { modified = true; }
    public void beforeEdgeRemoved(GraphRemoveEdgeEvent event) throws Exception { }
    public void afterEdgeRemoved(GraphRemoveEdgeEvent event) { modified = true; }
