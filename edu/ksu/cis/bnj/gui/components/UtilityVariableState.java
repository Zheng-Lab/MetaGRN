 ...
 */
public class UtilityVariableState extends VariableState {

	/**
	 * @param panel
	 */
	public UtilityVariableState(NodeManager owner, GraphPanel panel) {
		super(owner, panel);
	}
    ...
    protected BBNNode createNode(BBNGraph graph) {
        BBNNode  newNode = new BBNNode(graph, "Utility"+(counter++));
        newNode.setType(BBNNode.UTILITY);
        return newNode;
    }
}
