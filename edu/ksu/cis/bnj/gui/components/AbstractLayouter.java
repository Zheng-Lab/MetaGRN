...
public abstract class AbstractLayouter implements GraphLayoutManager {
    ...
    public void routeEdge( Graphics2D g2d, VisualEdge vEdge ) {
        ...
        Point2D.Float   fromcenter = new Point2D.Float(
            new Double( vaBounds.getCenterX()).floatValue(),
            new Double( vaBounds.getCenterY()).floatValue() );
        Point2D.Float   tocenter = new Point2D.Float(
            new Double( vbBounds.getCenterX()).floatValue(),
            new Double( vbBounds.getCenterY()).floatValue() );
