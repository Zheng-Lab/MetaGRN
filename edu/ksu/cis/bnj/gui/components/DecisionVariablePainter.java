...
public class DecisionVariablePainter extends VariablePainter {
    ...
    public void paint(VisualGraphComponent vgc, Graphics2D g2d) {
        ...
        x[0] = (int) bounds.getCenterX(); y[0] = (int) bounds.getY();
        x[1] = (int) bounds.getX();       y[1] = (int) bounds.getCenterY();
        x[2] = (int) bounds.getCenterX(); y[2] = (int) bounds.getMaxY();
        x[3] = (int) bounds.getMaxX();    y[3] = (int) bounds.getCenterY();
        // Close the diamond, otherwise, the bound checker can't detect it.
        x[4] = (int) bounds.getCenterX(); y[4] = (int) bounds.getY();
