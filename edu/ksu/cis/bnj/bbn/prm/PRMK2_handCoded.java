...
public class PRMK2_handCoded
{
	private int
	  mNumberOfNodes = 0;
	private String
		mGraphName= "ToyUniversity",
		mAttributeTableNames[],		
		mAttributeNames[],				
		mTableNames[];		
	...
	{	
		...
		mAttributeList[0].add(new String("Medium")); mAttributeList[0].add(new String("Low"));
		mAttributeNames[1] = "RANKING";
		mAttributeTableNames[1] = mTableNames[0];
		mAttributeList[1] = new LinkedList();
		mAttributeList[1].add(new String("High")); mAttributeList[1].add(new String("Medium")); mAttributeList[1].add(new String("Low"));
		mAttributeNames[2] = "POPULARITY";
		mAttributeTableNames[2] = mTableNames[1];
		mAttributeList[2] = new LinkedList();
		mAttributeList[2].add(new String("High")); mAttributeList[2].add(new String("Medium")); mAttributeList[2].add(new String("Low"));
		mAttributeNames[3] = "TEACHINGABILITY";
		mAttributeTableNames[3] = mTableNames[1];
		mAttributeList[3] = new LinkedList();		
		mAttributeList[3].add(new String("High")); mAttributeList[3].add(new String("Medium")); mAttributeList[3].add(new String("Low"));
		mAttributeNames[4] = "GRADE";
		mAttributeTableNames[4] = mTableNames[2];
		mAttributeList[4] = new LinkedList();
		mAttributeList[4].add(new String("A")); mAttributeList[4].add(new String("B")); mAttributeList[4].add(new String("C"));
		mAttributeNames[5] = "SATISFACTION";
		mAttributeTableNames[5] = mTableNames[2];
		mAttributeList[5] = new LinkedList();
		mAttributeList[5].add(new String("High")); mAttributeList[5].add(new String("Medium")); mAttributeList[5].add(new String("Low"));		
		mAttributeNames[6] = "RATING";
		mAttributeTableNames[6] =  mTableNames[3];
		mAttributeList[6] = new LinkedList();
		mAttributeList[6].add(new String("High")); mAttributeList[6].add(new String("Medium")); mAttributeList[6].add(new String("Low"));
		mAttributeNames[7] = "DIFFICULTY";
		mAttributeTableNames[7] =  mTableNames[3];
		mAttributeList[7] = new LinkedList();
		mAttributeList[7].add(new String("High")); mAttributeList[7].add(new String("Medium")); mAttributeList[7].add(new String("Low"));
	...
	protected BBNGraph getBBNGraph() 
	{
        ...
        BBNNode bbnNodes[] = new BBNNode[mNumberOfNodes];               
            ...
            System.out.println(valueSet);
          	indexTable.put(node.getName(), new Integer(j));
