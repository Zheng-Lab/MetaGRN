...
public class BifParser implements/*@bgen(jjtree)*/ BifParserTreeConstants,Converter, BifParserConstants {/*@bgen(jjtree)*/
  protected JJTBifParserState jjtree = new JJTBifParserState();protected Hashtable nodeCache = new Hashtable();
             ...
             if (dataList != null) {
                 ...
                 for (Iterator ee = dataSeries.iterator(); ee.hasNext(); )
                 {
                     ...
                     if (wrapper[0] instanceof String) {
                         ...
                         continue;
                     } else assert(wrapper[0] instanceof LinkedList);
...
*/
  ...
  String _s = null; Token t1 = null, t2 = null;
  Object o;
