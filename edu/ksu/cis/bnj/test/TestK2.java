...
//import edu.ksu.cis.bnj.bbn.learning.scorebased.sparse.*;
...
public class TestK2 {
    ...
    public static Table getExample() {
        ...
        Tuple t;
        t = new Tuple(); t.addValue(p); t.addValue(a); t.addValue(a); data.addTuple(t); // 1
        t = new Tuple(); t.addValue(p); t.addValue(p); t.addValue(p); data.addTuple(t); // 2
        t = new Tuple(); t.addValue(a); t.addValue(a); t.addValue(p); data.addTuple(t); // 3
        t = new Tuple(); t.addValue(p); t.addValue(p); t.addValue(p); data.addTuple(t); // 4
        t = new Tuple(); t.addValue(a); t.addValue(a); t.addValue(a); data.addTuple(t); // 5
        t = new Tuple(); t.addValue(a); t.addValue(p); t.addValue(p); data.addTuple(t); // 6
        t = new Tuple(); t.addValue(p); t.addValue(p); t.addValue(p); data.addTuple(t); // 7
        t = new Tuple(); t.addValue(a); t.addValue(a); t.addValue(a); data.addTuple(t); // 8
        t = new Tuple(); t.addValue(p); t.addValue(p); t.addValue(p); data.addTuple(t); // 9
        t = new Tuple(); t.addValue(a); t.addValue(a); t.addValue(a); data.addTuple(t); // 10
