...
// line 15 "Binomial_BetaBinomial_Example_KDS_Bimode.jweb"
/**
 * This class fits a
...
public class Binomial_BetaBinomial_Example_KDS_Bimode
{
  ...
  static public void main( String[] argv ) throws java.io.IOException
  {
    ...
    HastingsCoupledProposal proposal = new KernelDirectionSampler(10, var, prng );
    ...
    MCMCListenerWriter l1 = new StrippedListenerWriter("KDS.states.out");
    MCMCListenerHandle lh1 = pL.registerListener(l1);

    //
    // Create a listener that reports some useful information
    //
    MCMCListenerWriter l2 = new DistanceWriter("KDS.distance.out");
